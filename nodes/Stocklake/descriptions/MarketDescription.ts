...
export const marketOperations: INodeProperties = {
	...
	options: [
		...
		},
		{
			name: 'Get Movers',
			value: 'getMovers',
			description: 'Top gainers, losers and most-active stocks from the Stocklake universe (free)',
			action: 'Get market movers',
		},
		{
			name: 'Get Assessment',
			value: 'getAssessment',
			description: 'AI macro regime and market outlook in one call (requires Pro)',
...
export const marketFields: INodeProperties[] = [
	...
	},
	{
		...
		default: 0,
		typeOptions: { minValue: 0 },
		description: 'How many prior regime/outlook readings to include alongside the current one',
		displayOptions: {
