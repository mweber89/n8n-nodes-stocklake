	...
	options: [
		{
			name: 'Get Calendar',
			value: 'getCalendar',
			description: 'Upcoming earnings dates for stocks in the Stocklake universe (free)',
			action: 'Get earnings calendar',
		},
		{
			name: 'Get Intelligence',
			value: 'getIntelligence',
			description: 'Upcoming earnings with AI verdicts, risk factors and AI score (requires Pro)',
...
export const earningsFields: INodeProperties[] = [
	...
	},
	{
		...
		description: '0-100, applied before Limit truncates the result. Leave at 0 for no minimum.',
		displayOptions: {
			show: { resource: ['earnings'], operation: ['getIntelligence'] },
		},
	},
