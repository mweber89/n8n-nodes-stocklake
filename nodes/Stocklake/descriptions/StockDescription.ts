...
export const stockOperations: INodeProperties = {
  ...
  options: [
    ...
    },
    {
      ...
      description:
        "Historical daily snapshot of every technical indicator together (requires Pro)",
    ...
    },
    {
      ...
      description:
        "AI-synthesized insider and institutional sentiment (requires Pro)",
...
export const stockFields: INodeProperties[] = [
  ...
  },
  {
    ...
    description:
      "Max articles to return (free tier is capped at 5 regardless of this value)",
